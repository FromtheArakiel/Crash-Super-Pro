...
/**
 * Gives access to the private detonation of a creeper, which is what the chain reaction needs to
 * blow up a neighbour instantly.
 */
@Mixin(Creeper.class)
public interface CreeperInvoker {
    ...
    /** Lets the split mechanic drop a fresh creeper right at the brink of detonation. */
    @Accessor("swell")
