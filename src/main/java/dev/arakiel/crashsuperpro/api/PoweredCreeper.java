...
package dev.arakiel.crashsuperpro.api;

/**
 * 1.20.1 has no public setter for the charged state of a creeper, only the private data accessor,
 * so the mixin exposes one.
 */
public interface PoweredCreeper {
    void crashsuperpro$setPowered(boolean powered);
}
